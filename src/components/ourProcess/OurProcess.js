...
//     // Moving left decorative SVG
//     const leftVectorRef = useRef(null);
...
//                     // -------------------------------------------------------
//                     // Make background as wide as the entire horizontal track
//                     // -------------------------------------------------------
...
//                     // -------------------------------------------------------
//                     // Move background together with process cards
//                     // -------------------------------------------------------
//                     if (backgroundRef.current) {
//                         tl.to(
...
//                     // -------------------------------------------------------
//                     // Move left decorative SVG with horizontal scroll
//                     // -------------------------------------------------------
//                     if (leftVectorRef.current) {
//                         tl.to(
...
//                 className="relative overflow-hidden bg-[#062400] h-auto md:h-[120vh] z-10"
//             >
//                 <div className="ourprocessWrapper relative w-full h-full overflow-hidden">
...
//                     <div className="relative z-10 py-6 sm:py-8 md:py-10 w-[92%] sm:w-[90%] mx-auto h-full flex flex-col">
...
//                     {/* =====================================================
//                         DECORATIVE LEFT SVG
//                         Moves together with horizontal scroll
//                     ====================================================== */}
//                     <div
//                         ref={leftVectorRef}
//                         className="
...
//                         Stays on the right side for Step 06
//                     ====================================================== */}
//                     <div
//                         className="
//                             leftvectorProcess
...
//                     >
//                         <Image
//                             src="/images/ourprocessSvg02.svg"
//                             alt="ourprocessSvg"
//                             width={100}
//                             height={100}
//                             className="h-full w-full"
...
//     // Right decorative SVG - appears only at the end of horizontal scroll
//     const rightVectorRef = useRef(null);
...
//                     // -------------------------------------------------------
//                     // Show right decorative SVG only near the end
//                     // -------------------------------------------------------
//                     if (rightVectorRef.current) {
//                         gsap.set(rightVectorRef.current, {
//                             opacity: 0,
//                         });
...
//                     {/* =====================================================
//                         DECORATIVE RIGHT SVG
//                         Appears only at the end of horizontal scroll
//                     ====================================================== */}
//                     <div
//                         ref={rightVectorRef}
//                         className="
...
export default function OurProcess() {
    ...
    // Right decorative SVG - appears with Step 06
    const rightVectorRef = useRef(null);
        ...
        const initGSAP = async () => {
            ...
            mm = ScrollTrigger.matchMedia({
                "(min-width: 768px)": function () {
                    ...
                    // -------------------------------------------------------
                    // Show right decorative SVG when Step 06 comes into view
                    // -------------------------------------------------------
                    if (rightVectorRef.current) {
                        gsap.set(rightVectorRef.current, {
                            opacity: 0,
        ...
        <>
            ...
            >
                <div className="ourprocessWrapper relative w-full h-full overflow-hidden">
                    ...
                    {/* =====================================================
                        DECORATIVE RIGHT SVG
                        Appears when Step 06 comes into view
                    ====================================================== */}
                    <div
                        ref={rightVectorRef}
                        className="
